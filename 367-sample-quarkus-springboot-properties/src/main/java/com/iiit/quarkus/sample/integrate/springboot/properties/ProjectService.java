...
public class ProjectService {
	...
	void initData() {
		LOGGER.info("初始化数据");
		if (isInitData) {
			Project project1 = new Project(properties1.id,
					properties1.inform.name, properties1.inform.description);
			Project project2 = new Project(properties2.id,
					properties2.inform.name, properties2.inform.description);
	...
	public String getDescription() {
		return properties1.inform.description;
	}
