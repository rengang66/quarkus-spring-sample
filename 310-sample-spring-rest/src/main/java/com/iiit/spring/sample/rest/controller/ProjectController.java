...
public class ProjectController {
	...
	public Project getById(@Parameter(required = true, description = "Project name") @PathVariable("id")  Integer id) {		
	...
	public Set<Project> add( @Valid @RequestBody Project project) {
		return this.projectService.add(project);
	}

	@PostMapping(path ="/update",produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	@Operation(summary = "update a project", description = "update a new project")
	@ApiResponse(responseCode = "200", description = "Project added")
