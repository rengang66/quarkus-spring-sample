...
public class ProjectResource {
    ...
    public Uni<List<Project>> add(Project project) {    	
    	return service.add(project).onItem().ignore().andSwitchTo(this::list);
    	//return list();
    }
    ...
    public Uni<List<Project>> update(Project project) {
    	 return service.update(project).onItem().ignore().andSwitchTo(this::list);    	
    }
    
  //提交并删除一个project对象
    @DELETE
    public Uni<List<Project>> delete(Project project) {
    	 return service.delete(project).onItem().ignore().andSwitchTo(this::list);    	 
    }
