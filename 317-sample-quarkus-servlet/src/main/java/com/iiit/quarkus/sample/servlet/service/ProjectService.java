 ...
 */
package com.iiit.quarkus.sample.servlet.service;
...
public class ProjectService {
	...
	public String getSingleProjectInform(Integer id) {		
		Project project = getProjectById(id);
		if ( project == null){
			return "Project isn't exist.";
		}
		String projectInform = "{项目名称：" + project.name + "，" + "项目描述："
				+ project.description + "}";
