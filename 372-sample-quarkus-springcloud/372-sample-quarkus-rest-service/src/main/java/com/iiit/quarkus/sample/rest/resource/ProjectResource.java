...
@Tag(name = "Fruit Resource", description = "Endpoints for projects")
public class ProjectResource {
	...
	public Set<Project> delete(@Parameter(required = true, description = "Project to delete")  @PathParam("id") Integer id) {
