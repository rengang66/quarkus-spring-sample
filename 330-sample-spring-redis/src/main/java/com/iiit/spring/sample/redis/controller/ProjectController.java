 ...
 */
package com.iiit.spring.sample.redis.controller;
...
import com.iiit.spring.sample.redis.service.ProjectService;
...
public class ProjectController {
	...
	public Set<Project> list() {		
		//System.out.println("list方法获取全部数据");
	...
	public Project delete( @Valid @RequestBody Project project) {
