 ...
 */
package com.iiit.quarkus.sample.kubernetes.panache.resource;
...
import com.iiit.quarkus.sample.kubernetes.panache.domain.Project;
import com.iiit.quarkus.sample.kubernetes.panache.repository.ProjectRepository;
...
public class ProjectResource {
    ...
    public Project getById(@PathParam("id") Long id) {     	
    	Project entity = this.projectRepository.findById(id);
        if (entity == null) {
    ...
    public Project update(@PathParam("id") Long id, Project project) {    	
        ...
        this.projectRepository.persist(entity);
        return entity;
    }   
